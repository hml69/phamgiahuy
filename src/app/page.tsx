...
<div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
   <div className="max-w-lg w-full bg-gray-900 shadow-2xl rounded-lg overflow-hidden relative">
      {/* Header */} <div className="h-40 relative bg-cover bg-center" style={{ backgroundImage: "url('/images/background.gif')", // Đường dẫn ảnh nền }} > {/* Avatar với hiệu ứng gradient border */} 
         ...
         <div className="relative w-32 h-32 rounded-full border-4 border-gray-900">
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 p-1">
               <div className="w-full h-full rounded-full bg-gray-900 flex items-center justify-center transform hover:scale-105 transition duration-300">
                  <Image src="/images/avatar.jpg" // Thay bằng ảnh avatar alt="Profile Picture" width={120} height={120} className="rounded-full" />
               </div>
            </div>
         </div>
      </div>
   ...
   <div className="pt-20 pb-8 px-6 text-center">
      <h1 className="text-4xl font-extrabold text-white glow"> Phạm Gia Huy </h1>
      <p className="text-gray-400 mt-2 text-lg">Web Developer</p>
      <p className="text-sm text-gray-500 mt-4 leading-relaxed"> Xin chào mình là Phạm Gia Huy, là một lập trình viên chuyên về PHP. Để liên hệ với mình hãy vào các trang mạng xã hội của mình qua đường link phía dưới nha. </p>
      {/* Social Links */} 
      <div className="flex justify-center gap-6 mt-6">
         {/* Facebook */} 
         <a href="https://facebook.com/huyngudeochiuduoc" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 transition duration-300 transform hover:scale-125 hover:shadow-lg" >
         ...
         {/* GitHub */} 
         <a href="https://github.com/hml69" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-200 transition duration-300 transform hover:scale-125 hover:shadow-lg" >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" >
         ...
         {/* Telegram */} 
         <a href="https://t.me/pham_gia_huy" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition duration-300 transform hover:scale-125 hover:shadow-lg" >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" >
